...
* During dev `http://localhost:5/` can be accessed for CRUD operations such as POST, GET, PUT, DELETE etc. using Postman
...
* Repo created by [TommyTeaVee](https://github.com/TommyTeaVee), email: fihlatv@ygmail.com
